...
model.add(Flatten())
model.add(Dense(1024, activation='relu', kernel_regularizer=regularizers.L2(1e-3)))
model.add(Dropout(.3))
model.add(Dense(512, activation='relu', kernel_regularizer=regularizers.L2(1e-3)))
model.add(Dropout(.3))
